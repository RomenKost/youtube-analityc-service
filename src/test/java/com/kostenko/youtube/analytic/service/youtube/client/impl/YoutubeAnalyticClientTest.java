package com.kostenko.youtube.analytic.service.youtube.client.impl;
...
class YoutubeAnalyticClientTest {
    ...
    void getChannelTest() {
        ...
        when(restTemplate.getForObject("channels_url", YoutubeV3ApiChannelsDto.class, getUrlsParameters()))
                .thenReturn(v3ApiChannelsDto);
        when(channelMapper.youtubeV3ApiChannelsDtoToChannel(v3ApiChannelsDto))
                .thenReturn(expected);
    ...
    void getYoutubeVideoDtoTest() {
        ...
        when(restTemplate.getForObject("videos_url", YoutubeV3ApiVideosDto.class, parameters))
                .thenReturn(v3ApiVideosDto);
        when(videoMapper.videoDTOsToVideos(v3ApiVideosDto))
                .thenReturn(excepted);
